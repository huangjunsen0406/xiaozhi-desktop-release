const I18N = (() => {
  const translations = {
    zh: {
      ...
      'download.mac.btn': 'Apple Silicon (.dmg)',
      'download.win.desc': 'Windows 10 / 11 (64-bit)',
      'download.win.btn': 'Download for Windows',
      'download.win.note': 'Version ${version} · 64-bit Installer',
      'download.linux.desc': 'Ubuntu 20.04+ / Debian 11+',
      'download.linux.appimage': 'Download .AppImage',
      'download.linux.deb': 'Download .deb',
      ...
      'releases.mac.dmg': 'macOS Apple Silicon (.dmg)',
      'releases.win.exe': 'Windows x64 (.exe)',
      'releases.linux.appimage': 'Linux x64 (.AppImage)',
      'releases.linux.deb': 'Linux x64 (.deb)',
